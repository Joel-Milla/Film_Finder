# Film Finder
Film Finder is a project developed as part of a Front End Development Course, designed to interact with The Movie Database's ([TMDB](https://www.themoviedb.org/)) API. It presents users the ability to select a movie genre, then displays a random movie within that genre for the user to rate as liked or disliked. This options are saved internally. 
